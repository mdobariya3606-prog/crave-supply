...
<body>
    ...
    <main class="register-container">
        <section class="card" aria-labelledby="add-product-title">
            ...
            @if (session('success'))
                <div class="form-status alert-success" role="status">
                    {{ session('success') }}
                </div>
            @endif
            @if ($errors->any())
            ...
            >
                ...
                <div class="form-grid">
                        ...
                        <div class="input-wrapper">
                            ...
                            >
                                ...
                                @foreach ($categories as $category)
                                    <option
                                        value="{{ $category->id }}"
                                        @selected (old('category_id', $selectedCategory?->id) == $category->id)
                                    >
                                        {{ $category->name }}
                                    </option>
                                @endforeach
                    ...
                    <div
                        class="form-group{{ $errors->has('stock') ? ' has-error' : '' }}"
                    >
                        <label for="stock"
                            >Stock quantity
                    ...
                    <div
                        class="form-group full-width{{ $errors->has('images') ? ' has-error' : '' }}"
                    >
