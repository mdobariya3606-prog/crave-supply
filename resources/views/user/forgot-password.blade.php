...
<head>
    ...
    <style>
        ...
        .mail-submit-spinner {
            ...
            border-radius: 50%;
            animation: mail-submit-spin 0.7s linear infinite;
        }
    ...
    <main class="register-container">
        <section class="card" aria-labelledby="forgot-title">
            ...
            <div class="auth-snack-note">
                <img
                    src="https://images.unsplash.com/photo-1499636136210-6f4ee915583e?auto=format&amp;fit=crop&amp;w=240&amp;q=78"
                    alt="Freshly baked cookies"
                />
                <div>
                    <strong>Your snack shelf is waiting.</strong>
                    <span
                        >Reset your password and get back to your next
                        restock.</span
                    >
                </div>
            </div>
            ...
            >
                ...
                >
                    ...
                    <div
                        id="emailError"
                        class="error-text{{ $message ? ' is-visible' : '' }}"
                        role="alert"
                    >
