...
<body>
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input id="name" name="name" type="text" value="{{ old('name') }}" required
                                minlength="3" maxlength="255" autocomplete="name" placeholder="Alex Morgan"
                        ...
                        <div id="nameError" class="error-text{{ $errors->has('name') ? ' is-visible' : '' }}"
                    ...
                    <div class="form-group{{ $errors->has('business_name') ? ' has-error' : '' }}">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input id="business_name" name="business_name" type="text"
                                value="{{ old('business_name') }}" maxlength="255" autocomplete="organization"
                                placeholder="Morgan Foods Ltd." aria-describedby="business_nameError">
                            <svg class="input-icon" viewBox="0 0 24 24" aria-hidden="true">
                                <path d="M3 21h18" />
                        ...
                        <div id="business_nameError"
                            class="error-text{{ $errors->has('business_name') ? ' is-visible' : '' }}" role="alert">
                    ...
                    <div class="form-group full-width{{ $errors->has('business_address') ? ' has-error' : '' }}">
                        ...
                        <div class="input-wrapper">
                            ...
                            <textarea id="business_address" name="business_address" maxlength="255" autocomplete="street-address"
                                placeholder="123 Market Street, City, State" aria-describedby="business_addressError">{{ old('business_address') }}</textarea>
                            <svg class="input-icon input-icon-top" viewBox="0 0 24 24" aria-hidden="true">
                                <path d="M20 10c0 5-8 11-8 11S4 15 4 10a8 8 0 1 1 16 0Z" />
                                <circle cx="12" cy="10" r="2.5" />
                            </svg>
                        </div>
                        <div id="business_addressError"
                    ...
                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input id="email" name="email" type="email" value="{{ old('email') }}"
                                required maxlength="255" autocomplete="email" placeholder="you@company.com"
                        ...
                        <div id="emailError" class="error-text{{ $errors->has('email') ? ' is-visible' : '' }}"
                            role="alert"><svg viewBox="0 0 24 24" aria-hidden="true">
                                <circle cx="12" cy="12" r="10" />
                                <line x1="12" y1="8" x2="12" y2="12" />
                                <line x1="12" y1="16" x2="12.01" y2="16" />
                    ...
                    <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input id="phone" name="phone" type="tel" maxlength=10
                                value="{{ old('phone') }}" maxlength="30" autocomplete="tel"
                                placeholder="+91 98765 43210" aria-describedby="phoneError">
                            <svg class="input-icon" viewBox="0 0 24 24" aria-hidden="true">
                                <rect x="6" y="3" width="12" height="18" rx="2" />
                                <path d="M10 18h4" />
                            </svg>
                        </div>
                        <div id="phoneError" class="error-text{{ $errors->has('phone') ? ' is-visible' : '' }}"
                            role="alert"><svg viewBox="0 0 24 24" aria-hidden="true">
                                <circle cx="12" cy="12" r="10" />
                                <line x1="12" y1="8" x2="12" y2="12" />
                                <line x1="12" y1="16" x2="12.01" y2="16" />
    ...
    <script>
        ...
        const fields = [...registerForm.querySelectorAll('input[name], textarea[name]')];
        ...
        function getErrorMessage(field) {
            ...
            if (field.validity.valueMissing) return emptyFieldMessages[field.name] || '';
        ...
        registerForm.addEventListener('submit', async (event) => {
            ...
            try {
                ...
                showStatus(data.message || 'Registration submitted successfully.');
                registerForm.reset();
            } catch (error) {
                showStatus('Unable to connect right now. Please try again.', 'error');
            } finally {
