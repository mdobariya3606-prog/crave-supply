...
<body>
    ...
    <main class="register-container">
        <section class="card" aria-labelledby="login-title">
            ...
            <footer class="form-footer">
                New to CraveSupply? <a href="{{ url('/register') }}">Create an account</a>
            </footer>
        </section>
    </main>
    ...
    <script>
        ...
        function validateField(field) {
            ...
            else if (field.validity.tooLong) message = `Use no more than ${field.maxLength} characters.`;
        ...
        loginForm.addEventListener('submit', (event) => {
            ...
            if (!valid) {
                ...
                [email, password].find((field) => !validateField(field))?.focus();
            }
        });
