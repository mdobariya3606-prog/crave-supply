...
<body>
        ...
        <section class="card" aria-labelledby="profile-title">
            ...
            <form
                    ...
                    <div
                        ...
                        <div class="input-wrapper">
                            ...
                            <input
                                ...
                                aria-describedby="nameError" /><svg
                                class="input-icon"
                                viewBox="0 0 24 24"
                                aria-hidden="true">
                    ...
                    <div
                        ...
                        <div class="input-wrapper">
                            ...
                            <input
                                ...
                                aria-describedby="business_nameError" /><svg
                                class="input-icon"
                                viewBox="0 0 24 24"
                                aria-hidden="true">
                                <path d="M3 21h18" />
                    ...
                    <div
                        ...
                        <div class="input-wrapper">
                            ...
                            <textarea
                                ...
                                aria-describedby="business_addressError">{{ old('business_address', auth()->user()->business_address) }}</textarea><svg
                    ...
                    <div
                        ...
                        <div class="input-wrapper">
                            ...
                            <input
                                ...
                                aria-describedby="phoneError" /><svg
                                class="input-icon"
                                viewBox="0 0 24 24"
                                aria-hidden="true">
                ...
                <div class="profile-actions">
                    <a class="secondary-btn" href="{{ route('dashboard') }}">Cancel</a><button type="submit" class="btn-submit">
                        Save changes
                    </button>
                </div>
            </form>
            <footer class="form-footer">
                ...
                <a href="mailto:hello@cravesupply.test">Contact support</a>
            </footer>
            <form
    ...
    <script>
        ...
        const fields = [
            ...profileForm.querySelectorAll("input[name], textarea[name]"),
        ];
