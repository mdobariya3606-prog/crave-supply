...
<body>
                ...
                <div class="login-fields">
                    <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                        ...
                        <div class="input-wrapper">
                            ...
                            </svg><button type="button" class="pass-toggle" onclick="togglePassword('password', this)"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input id="password_confirmation" name="password_confirmation" type="password" required
                                ...
                                placeholder="Re-enter your password" aria-describedby="password_confirmationError"><svg
                        ...
                        <div id="password_confirmationError" class="error-text" role="alert"><svg viewBox="0 0 24 24"
                                aria-hidden="true">
    ...
    <script>
        ...
        function validateField(field) {
            ...
            else if (field.name === 'password_confirmation' && field.value !== password.value) message =
