    ...
    <main class="contact-page">
        <div class="contact-grid">
            <section class="contact-intro">
                ...
                <p>Need help choosing products, planning a restock, or finding something specific? Send us a note and our team will get back to you.</p>
                <div class="contact-details">
                    <strong>Email</strong><span>hello@cravesupply.test</span
                    ><strong>Hours</strong><span>Monday–Friday, 9:00–18:00</span
