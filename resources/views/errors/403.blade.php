...
<body>
    <main class="error-page">
        <section class="error-card">
            ...
            <p>You don’t have permission to view this page. If you believe this is a mistake, please contact the CraveSupply team.</p>
            <div class="error-actions">
                <a class="btn btn-primary" href="{{ url('/dashboard') }}"
                    >Go to dashboard</a
                ><a class="btn btn-secondary" href="{{ url('/contact') }}"
                    >Contact support</a
                >
            </div>
