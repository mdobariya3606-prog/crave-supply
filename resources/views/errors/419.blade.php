...
<body>
    <main class="error-page">
        <section class="error-card">
            ...
            <div class="error-actions"><a class="btn btn-primary" href="{{ url()->previous() !== url()->current() ? url()->previous() : url('/') }}">Try again</a><a
                    class="btn btn-secondary" href="{{ route('login') }}">Log in</a></div>
