...
<body>
    <main class="error-page">
        <section class="error-card">
            ...
            <p>Something went wrong on our side. Please try again in a moment, or return to your dashboard while we
                check the issue.</p>
            <div class="error-actions"><a class="btn btn-primary" href="{{ url('/dashboard') }}">Back to dashboard</a><a
                    class="btn btn-secondary" href="{{ url('/') }}">Return home</a></div>
